<header class="main-nav">
          <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="<?php echo base_url('assets/back/assets');?>/images/dashboard/1.png" alt="">
            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li><a class="nav-link menu-title link-nav<?php echo active('default');?>" href="<?php echo base_url('admin/default');?>"><i data-feather="home"></i><span>Anasayfa</span></a></li>
