          ...
          <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="needs-validation" autocomplate="off" method="post" action="<?php echo base_url('admin/CategoryAdd');?>">
                      <div class="row g-3">
                        <div class="col-md-6">
                          <label class="form-label" for="categoryName">Kategori Adı</label>
                          <input class="form-control" id="categoryName" name="category" type="text" required="" >
